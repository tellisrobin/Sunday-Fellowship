  ...
  return (
    <>
      ...
      <Drawer title="Menu" placement="right" onClose={onClose} visible={drawerVisible}>
        <NavLink className="nav-link" activeClassName="active" exact to="/team" onClick={onClose}>
          Our Team
        </NavLink>
        <NavLink className="nav-link" activeClassName="active" exact to="/who-we-are" onClick={onClose}>
          Who We Are
        </NavLink>
        <NavLink className="nav-link" activeClassName="active" exact to="/events" onClick={onClose}>
          Events
        </NavLink>
        <NavLink className="nav-link" activeClassName="active" exact to="/contact-us" onClick={onClose}>
          Contact us
        </NavLink>
      </Drawer>
    </>
