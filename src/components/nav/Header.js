  ...
  return (
    <>
      <Row align="middle" justify="space-between" className="header">
        ...
        <Col xs={0} sm={16} md={14} lg={12}>
          <div className="nav-links-container">
            ...
            <NavLink className="nav-link ripple" exact to="/who-we-are" aria-current="page">
              Who We Are
            </NavLink>
            <NavLink className="nav-link ripple" exact to="/events" aria-current="page">
              Events
            </NavLink>
      ...
      <Drawer title="Menu" placement="right" onClose={onClose} visible={drawerVisible}>
        ...
        <NavLink className="nav-link ripple" exact to="/who-we-are" onClick={onClose} aria-current="page">
          Who We Are
        </NavLink>
        <NavLink className="nav-link ripple" exact to="/events" onClick={onClose} aria-current="page">
          Events
        </NavLink>
